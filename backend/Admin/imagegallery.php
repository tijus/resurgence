    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <?php
          include("dbcon.php");
          $check=mysqli_query($con,"SELECT COUNT(id) FROM `gallery`");
          ...
          if($count==0)
          {
            echo "<h3><strong>No images Added Yet!</strong><br><br></h3>";
          }
          else
          {
          ?>
...
echo "</td>";
echo "<td>";
echo "<form action=del_imagegallery.php method=post><button type=submit class=btn btn-default name=del value=$id onclick=del_confirm()>Delete</button></form>";
echo "</td>";
echo "</tr>";
}
?>
...
?>
         <div class="col-md-8">
              <div class="box box-default collapsed-box box-solid">
                ...
                <div class="box-body">
                  <form action=add_imagegallery.php role="form" method="post" enctype="multipart/form-data">
                      ...
                      <select class="form-control" id="workshop" name="event">
