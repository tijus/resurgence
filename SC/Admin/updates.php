    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <?php
          include("dbcon.php");
          $check=mysqli_query($con,"SELECT COUNT(id) FROM `updates`");
          ...
          if($count==0)
          {
            echo "<h3><strong>No updates Added Yet!</strong><br><br></h3>";
          }
          else
          {
          ?>
...
error_reporting(0);
$i=0;
$result = mysqli_query($con,"SELECT * FROM updates where role='$roleget' ORDER BY(`id`) DESC");

while($row = mysqli_fetch_array($result))
{
$title=$row['UpdateTitle'];
$id=$row['id'];
$url=$row['ImagePath'];
$desp=$row['UpdateDescription'];
$i++;
echo "<tr>";
echo "<td>";
echo $i;
...
echo "</td>";
echo "<td>";
echo "<form action=del_update.php method=post><button type=submit class=btn btn-default name=del value=$id onclick=del_confirm()>Delete</button></form>";
echo "</td>";
echo "</tr>";
}
?>
...
?>
         <div class="col-md-8">
              <div class="box box-default collapsed-box box-solid">
                ...
                <div class="box-body">
                  <form action=add_update.php role="form" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                      <label>Title:</label>
                      <input type="text" class="form-control" id="workshop" name="title" placeholder="Enter Title"/></div>
                      <div class="form-group">
                      <label>Description:</label>
                      <div class="form-group">
                        <textarea class="form-control" rows="2" name="desp"></textarea>
                      </div>
                      <div class="form-group">
