    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <?php
          include("dbcon.php");
          $check=mysqli_query($con,"SELECT COUNT(ID) FROM `admission`");
...
error_reporting(0);
$i=0;
$result = mysqli_query($con,"SELECT * FROM admission ORDER BY(`ID`) ASC");
...
echo "</td>";
echo "<td>";
echo "<form action=del_admission.php method=post><button type=submit class=btn btn-default name=del value=$id onclick=del_confirm()>Delete</button></form>";
echo "</td>";
echo "</tr>";
}
?>
...
?>
         <div class="col-md-3">
              <div class="box box-default collapsed-box box-solid">
                ...
                <div class="box-body">
                  <form action=add_admission.php role="form" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                      <label>Label:</label>
                      <input type="text" class="form-control" id="workshop" name="label" placeholder="Enter Label"/></div>
                      <div class="form-group">
                      <label>Category:</label>
                      <select class="form-control" id="workshop" name="matter">
                            <option value="">select</option>
                            <option value="FE Admission">FE Admission</option>
                            <option value="DSE Admission">DSE Admission</option>
                            <option value="SE, TE, BE Admission">SE, TE, BE Admission</option>
