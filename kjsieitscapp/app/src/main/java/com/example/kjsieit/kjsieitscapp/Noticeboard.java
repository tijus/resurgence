...
public class Noticeboard extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView=(WebView)findViewById(R.id.noticeboard);
        final WebSettings webSettings=webView.getSettings();
        webSettings.setJavaScriptEnabled(true);
        //webSettings.setCacheMode(WebSettings.LOAD_CACHE_ELSE_NETWORK);
        webView.loadUrl("http://kjsieit.in/SC/app/noticeboard.php?matter="+mcn);
        webView.setWebViewClient(new com.example.kjsieit.kjsieitscapp.MyAppWebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                findViewById(R.id.noticeboard).setVisibility(View.VISIBLE);
            ...
            public void onReceivedError(final WebView view, int errorCode, String description,
                ...
                Toast.makeText(Noticeboard.this, "Please connect to internet",Toast.LENGTH_LONG).show();
                webView.loadUrl("about:blank");
                startActivity(new Intent(Noticeboard.this, NoInternet.class));
