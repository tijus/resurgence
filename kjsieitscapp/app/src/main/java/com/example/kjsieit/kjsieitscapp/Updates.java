...
public class Updates extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView=(WebView)findViewById(R.id.mupdates);
        WebSettings webSettings=webView.getSettings();
        webSettings.setJavaScriptEnabled(true);


        webView.loadUrl("http://kjsieit.in/SC/app/updates.php?role="+role);
        webView.setWebViewClient(new com.example.kjsieit.kjsieitscapp.MyAppWebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                findViewById(R.id.mupdates).setVisibility(View.VISIBLE);
            }
            public void onReceivedError(final WebView view, int errorCode, String description,
                ...
                startActivity(new Intent(Updates.this, NoInternet.class));
