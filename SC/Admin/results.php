    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <?php
          include("dbcon.php");
          $check=mysqli_query($con,"SELECT COUNT(Id) FROM `results`");
...
error_reporting(0);
$i=0;
$result = mysqli_query($con,"SELECT * FROM results ORDER BY(`ID`) ASC");
while($row = mysqli_fetch_array($result))
{
$id=$row['id'];
$title=$row['Class'];
$session=$row['Class_sess'];
$url=$row['Url'];
...
echo "</td>";
echo "<td>";
echo "<form action=del_results.php method=post><button type=submit class=btn btn-default name=del value=$id onclick=del_confirm()>Delete</button></form>";
echo "</td>";
...
?>
         <div class="col-md-3">
		      ...
		      <div class="form-group">
                      <label>Branch:</label>
                      <select class="form-control" id="workshop" name="branch">
                          ...
                          <div class="form-group">
                      <label>Year:</label>
                      <select class="form-control" id="workshop" name="year">
                            <option value="">select</option>
                      ...
                      <select class="form-control" id="workshop" name="class">
                            <option value="">select</option>
                  ...
                  <div class="form-group">
                      <label>Session:</label>
                      <input type="text" placeholder="Type the session like May 2016" class="form-control" id="workshop" name="session" /></div>
                <div class="form-group">
...
$date = date('d/m/Y');?>
                      ...
                      <select class="form-control" id="workshop" name="syllabus">
                            <option value="">select</option>
